try {
    ...
    if (!_xnext_included && !window.location.href.match(/fb_xd_fragment/g)) {
        ...
        (function() {
            ...
            tryInjectRosettaScript('https://d3hlm6p2n1wjk4.cloudfront.net/rosetta/translations/new-frontend/files/new-frontend.en.1635387138.js');
        })();
        (function() {
            window.ecwid_init_elm_config = function() {
                function load() {
                    ...
                    script.src = selectJsVersion('https://d3hlm6p2n1wjk4.cloudfront.net/venera/static/ecwid-storefront.5582713b95e944cdc4603062f5f3d324.min.js');
                    document.getElementsByTagName('head')[0].appendChild(script);
                }
                ...
                function loadCheckout(callback) {
                    ...
                    script.src = selectJsVersion('https://d3hlm6p2n1wjk4.cloudfront.net/venera/static/ecwid-checkout.f3bbd76f1a2b994e96b602ef0240616c.min.js');
                    document.getElementsByTagName('head')[0].appendChild(script);
                }
        ...
        window.Ecwid = {
            ...
            signature: "810d8ad971367d17100bfdaab8976c9f-0",
            ...
            _injectEcwidCss: function() {
                ...
                window.ec_legacyCssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new/cut?hc=1145371546&ownerid=29410207&useProximaNovaFont=true' + cssUrlAddition;
                var cssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=1145371546&ownerid=29410207&useProximaNovaFont=true' + cssUrlAddition;
    ...
    <div class="ecwid-pb-placeholder__product"></div><div class="ecwid-pb-placeholder__title"><div></div><div></div><div></div></div>\
                ...
                if ((!window.ecwid_bodyDone && !Ecwid._hasFacebookIframe() && !window.ecwid_dynamic_widgets) || window.ecwid_dynamic_widgets && !window.ecwid_bodyDone) {
                    ...
                    if (useStubbedVersion) {
                        ...
                        ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub = function() {
                            var P = 'bootstrap',
                                Q = 'begin',
                                R = 'gwt.codesvr.ru.cdev.xnext.legacyfrontendstub.LegacyFrontendStub=',
                                S = 'gwt.codesvr=',
                                T = 'ru.cdev.xnext.legacyfrontendstub.LegacyFrontendStub',
                                U = 'startup',
                                V = 'DUMMY',
                                W = 0,
                                X = 1,
                                ...
                                pb = 'meta',
                                qb = 'name',
                                rb = 'ru.cdev.xnext.legacyfrontendstub.LegacyFrontendStub::',
                                sb = '::',
                                tb = 'gwt:property',
                                ub = 'content',
                                vb = '=',
                                ...
                                Fb = 'clear.cache.gif',
                                Gb = 'baseUrl',
                                Hb = 'ru.cdev.xnext.legacyfrontendstub.LegacyFrontendStub.nocache.js',
                                Ib = 'base',
                                Jb = '//',
                                Kb = 'user.agent',
                                Lb = 'webkit',
                                ...
                                _b = 3,
                                ac = 4,
                                bc = 'selectingPermutation',
                                cc = 'ru.cdev.xnext.legacyfrontendstub.LegacyFrontendStub.devmode.js',
                                dc = '03D3491C1C0004D51A14D35D69C8EF65',
                                ec = '4C6EEA36409EDE95BE3E6AB89BAA7E79',
                                fc = 'B0B37E912AC3F4BC5B866E09A4E3B785',
                                gc = 'B5BC70EC7FE816DD31A4ACCC370504D5',
                                hc = 'DD4B4C0EF079DEF917E0F40109DBCF86',
                                ic = ':',
                                jc = '.cache.js',
                                kc = 'loadExternalRefs',
                                lc = 'end',
                                ...
                                oc = 'file:',
                                pc = '_gwt_dummy_',
                                qc = '__gwtDevModeHook:ru.cdev.xnext.legacyfrontendstub.LegacyFrontendStub',
                            ...
                            function q() { var a = o.location.search; return a.indexOf(R) != -1 || a.indexOf(S) != -1 }
                            ...
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__sendStats = r;
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__moduleName = T;
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__errFn = null;
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__moduleBase = V;
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__softPermutationId = W;
                            ...
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__gwtStartLoadingFragment = function() { return null };
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__gwt_isKnownPropertyValue = function() { return false };
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__gwt_getMetaProperty = function() { return null };
                            var s = null;
                            ...
                            function A(f) {
                                function g(a) {
                                    function b() { if (typeof p.readyState == eb) { return typeof p.body != eb && p.body != null } return /loaded|complete/.test(p.readyState) }
                                    var c = b();
                                    if (c) { a(); return }
                                    ...
                                    function d() {
                                        if (!c) {
                                            ...
                                            c = true;
                                            a();
                                            if (p.removeEventListener) { p.removeEventListener(fb, d, false) }
                                            if (e) { clearInterval(e) }
                                        }
                                    }
                                    if (p.addEventListener) { p.addEventListener(fb, d, false) }
                                    var e = setInterval(function() { d() }, gb)
                                }

                                function h(a) {
                                    var b = v();
                                    var c = b.body;
                                    var d = b.createElement(hb);
                                    if (typeof ecwid_addCspNonceToScript === ib) { ecwid_addCspNonceToScript(d) }
                                    d.language = jb;
                                    d.src = a;
                                    if (ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__errFn) { d.onerror = function() { ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__errFn(kb, new Error(lb + a)) } }
                                    c.appendChild(d);
                                    r(mb, nb)
                                }
                                r(mb, ob);
                            ...
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__startLoadingFragment = function(a) { return F(a) };
                            ...
                            function C() {
                                ...
                                for (var g = W, h = f.length; g < h; ++g) {
                                    ...
                                    if (j) {
                                        ...
                                        } else if (j == wb) { k = i.getAttribute(ub); if (k) { try { d = eval(k) } catch (a) { alert(xb + k + yb) } } } else if (j == zb) { k = i.getAttribute(ub); if (k) { try { e = eval(k) } catch (a) { alert(xb + k + Ab) } } }
                                    }
                                }
                            ...
                            function D() {
                                if (window.ecwid_script_base) { n = window.ecwid_script_base; return n }

                                function e(a) { var b = a.lastIndexOf(Bb); if (b == -1) { b = a.length } var c = a.indexOf(Cb); if (c == -1) { c = a.length } var d = a.lastIndexOf(Db, Math.min(c, b)); return d >= W ? a.substring(W, d + X) : cb }
                            ...
                            function G() {
                                ...
                                function h(a, b) {
                                    var c = f;
                                    for (var d = W, e = a.length - X; d < e; ++d) { c = c[a[d]] || (c[a[d]] = []) }
                                    c[a[e]] = b
                                }
                                var i = [];
                                var j = [];
                                ...
                                i[Kb] = { 'gecko1_8': W, 'ie10': X, 'ie8': $b, 'ie9': _b, 'safari': ac };
                                __gwt_isKnownPropertyValue = function(a, b) { return b in i[a] };
                                ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__getPropMap = function() { var a = {}; for (var b in i) { if (i.hasOwnProperty(b)) { a[b] = k(b) } } return a };
                                ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__computePropValue = k;
                                o.__gwt_activeModules[T].bindings = ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__getPropMap;
                                r(P, bc);
                                if (q()) { return F(cc) }
                                var l;
                                try {
                            ...
                            C();
                            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__moduleBase = D();
                            t[T].moduleBase = ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__moduleBase;
                            var I = G();
                            if (o) {
                                var J = !!(o.location.protocol == mc || (o.location.protocol == nc || o.location.protocol == oc));
                                o.__gwt_activeModules[T].canRedirect = J;
                                ...
                                if (J && K()) {
                                    ...
                                    if (!/^https:\/\/\w+.local.ecwid.com(:\d+)?\/.*$/.test(M)) {
                                        if (M && (window.console && console.log)) { console.log(rc + M) }
                                        M = cb
                                    }
                                    if (M && !o[L]) {
                                        o[L] = true;
                                        o[L + sc] = D();
                                        var N = p.createElement(hb);
                                        N.src = M;
                                        var O = p.getElementsByTagName(tc)[W];
                            ...
                            H();
                            r(P, lc);
                            if (window.needLoadEcwidAsync) { B(I) } else { A(I) }
                            return true
                        }
                        ...
                        ru_cdev_xnext_legacyfrontend_LegacyFrontend = function() {
                            var P = 'bootstrap',
                                Q = 'begin',
                                R = 'gwt.codesvr.ru.cdev.xnext.legacyfrontend.LegacyFrontend=',
                                S = 'gwt.codesvr=',
                                T = 'ru.cdev.xnext.legacyfrontend.LegacyFrontend',
                                U = 'startup',
                                V = 'DUMMY',
                                W = 0,
                                X = 1,
                                ...
                                pb = 'meta',
                                qb = 'name',
                                rb = 'ru.cdev.xnext.legacyfrontend.LegacyFrontend::',
                                sb = '::',
                                tb = 'gwt:property',
                                ub = 'content',
                                vb = '=',
                                ...
                                Fb = 'clear.cache.gif',
                                Gb = 'baseUrl',
                                Hb = 'ru.cdev.xnext.legacyfrontend.LegacyFrontend.nocache.js',
                                Ib = 'base',
                                Jb = '//',
                                Kb = 'user.agent',
                                Lb = 'webkit',
                                ...
                                ac = 4,
                                bc = 'selectingPermutation',
                                cc = 'ru.cdev.xnext.legacyfrontend.LegacyFrontend.devmode.js',
                                dc = '17E25F1FDDAD60DF293FFF0E392DB29C',
                                ec = '61CFD1AE3A3EA42C2DA12EDAAE715ACE',
                                fc = '6BB879F4E7663E0EACBAA8B44D2F58D8',
                                gc = 'B833D2B79A92C8C3D18C6DF7F13CA060',
                                hc = 'B97A7C3FC5C2378019E866002E726C2D',
                                ic = ':',
                                jc = '.cache.js',
                                kc = 'loadExternalRefs',
                                lc = 'end',
                                ...
                                oc = 'file:',
                                pc = '_gwt_dummy_',
                                qc = '__gwtDevModeHook:ru.cdev.xnext.legacyfrontend.LegacyFrontend',
                                rc = 'Ignoring non-whitelisted Dev Mode URL: ',
                                sc = ':moduleBase',
                                tc = 'head';
                            var n;
                            ...
                            function r(a, b) { if (o.__gwtStatsEvent) { o.__gwtStatsEvent({ moduleName: T, sessionId: o.__gwtStatsSessionId, subSystem: U, evtGroup: a, millis: (new Date).getTime(), type: b }) } }
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__sendStats = r;
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__moduleName = T;
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__errFn = null;
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__moduleBase = V;
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__softPermutationId = W;
                            ...
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__gwtStartLoadingFragment = function() { return null };
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__gwt_isKnownPropertyValue = function() { return false };
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__gwt_getMetaProperty = function() { return null };
                            var s = null;
                            var t = o.__gwt_activeModules = o.__gwt_activeModules || {};
                            t[T] = { moduleName: T };
                            ...
                            function A(f) {
                                ...
                                function h(a) {
                                    ...
                                    d.language = jb;
                                    d.src = a;
                                    if (ru_cdev_xnext_legacyfrontend_LegacyFrontend.__errFn) { d.onerror = function() { ru_cdev_xnext_legacyfrontend_LegacyFrontend.__errFn(kb, new Error(lb + a)) } }
                                    c.appendChild(d);
                                    r(mb, nb)
                                }
                                r(mb, ob);
                            ...
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__startLoadingFragment = function(a) { return F(a) };
                            ...
                            function G() {
                                ...
                                i[Kb] = { 'gecko1_8': W, 'ie10': X, 'ie8': $b, 'ie9': _b, 'safari': ac };
                                __gwt_isKnownPropertyValue = function(a, b) { return b in i[a] };
                                ru_cdev_xnext_legacyfrontend_LegacyFrontend.__getPropMap = function() { var a = {}; for (var b in i) { if (i.hasOwnProperty(b)) { a[b] = k(b) } } return a };
                                ru_cdev_xnext_legacyfrontend_LegacyFrontend.__computePropValue = k;
                                o.__gwt_activeModules[T].bindings = ru_cdev_xnext_legacyfrontend_LegacyFrontend.__getPropMap;
                                r(P, bc);
                                if (q()) { return F(cc) }
                                var l;
                                try {
                            ...
                            C();
                            ru_cdev_xnext_legacyfrontend_LegacyFrontend.__moduleBase = D();
                            t[T].moduleBase = ru_cdev_xnext_legacyfrontend_LegacyFrontend.__moduleBase;
                            var I = G();
                            if (o) {
                                var J = !!(o.location.protocol == mc || (o.location.protocol == nc || o.location.protocol == oc));
                                o.__gwt_activeModules[T].canRedirect = J;
        ...
        if (!Ecwid._isNewStorefrontOnly()) {
            xInjectJs('https://d3hlm6p2n1wjk4.cloudfront.net/static/br/2020-26929-gda380219357/lang/en.js');
        }
        xInjectJs('https://app.ecwid.com/states.js?hc=2144481444&callback=window.ecwid_states_data.loaded');
        ...
        window.ecwid_script_base = "https://d3hlm6p2n1wjk4.cloudfront.net/static/br/2020-26929-gda380219357/";
        ...
        window.xnext_ownerId = 29410207;
        window.Ecwid.publicToken = "public_F2FFN4SWGTUxw7gdBvE1WPbFLSAxEysc",
            window.Ecwid.demo = false;
        window.Ecwid.cssUrl = "https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=1145371546&ownerid=29410207&useProximaNovaFont=true";
        ...
        (function() {
            ...
            var ecDataJsBaseUrl = "https://app.ecwid.com/data.js?ownerid=29410207";
        ...
        window.Ecwid.getAppPublicConfig = function(namespace) {
            var publicData = { "ecwid-degenerator-app": "{}", "storefront-label-editor": "", "starter-site": "{}", "razorpay-dsign": "{}", "ecwid-storefront": "{}", "google-shopping": "{}" };
        ...
        window.Ecwid.getAppPublicToken = function(namespace) {
            var tokenMap = { "google-shopping": "public_ebr92Yf1FZ7gdVmpLdr7vXnVkCrRRf9b", "ecwid-storefront": "public_fn16hxQ87fxz9RC2tDngyUBSwSKbTSqH" };
        ...
        if (!window.__heap_inits__ && !(((window.ec || {}).config || {}).disable_all_cookies === true)) {
            (function(i, s, o, g, r, a, m) {
                ...
                if (Ecwid._isInteractiveEnabled() && m != null && m.parentNode != null) m.parentNode.insertBefore(a, m);
                    ...
                    k = setInterval(function() { if ((/loaded|complete/.test(s.readyState) || 0 == h--) && m != null && m.parentNode != null) m.parentNode.insertBefore(a, m), clearInterval(k) }, 100)
